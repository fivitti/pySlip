...
# this can be overridden in the STMTiles() constructor
...
######
# Override the pyCacheBack object to handle STM tile retrieval
######

class STMCache(pycacheback.pyCacheBack):
...
################################################################################
# Class for STM tiles.   Builds on tiles.Tiles.
################################################################################

class STMTiles(tiles.Tiles):
    """An object to source STM tiles for pySlip."""
    ...
    def __init__(self, tiles_dir=None, tile_levels=None, callback=None,
        ...
        # tiles extent for STM tile data (left, right, top, bottom)
        ...
        self.cache = STMCache(tiles_dir=self.tiles_dir, max_lru=DefaultMaxLRU)

        # set the list of queued unsatisfied requests to 'empty'
        self.queued_requests = {}

        # STM tiles always (256, 256)
